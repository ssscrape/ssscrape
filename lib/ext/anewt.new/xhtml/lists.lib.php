 ...
 */
abstract class AnewtXHTMLListBase extends AnewtXHTMLBlockElement
{
	...
	function render($indent_level=0)
	{
		...
		return AnewtXHTMLBlockElement::render($indent_level);
	}
}
 ...
 */
final class AnewtXHTMLUnorderedList extends AnewtXHTMLListBase
{
	public $node_name = 'ul';
}
 ...
 * \see http://www.w3.org/TR/html4/struct/lists.html#h-10.2
 */
final class AnewtXHTMLOrderedList extends AnewtXHTMLListBase
{
	public $node_name = 'ol';
}
 ...
 * \see http://www.w3.org/TR/html4/struct/lists.html#h-10.2
 */
final class AnewtXHTMLListItem extends AnewtXHTMLElement
{
	public $node_name = 'li';
}
 ...
 */
final class AnewtXHTMLDefinitionList extends AnewtXHTMLListBase
{
	public $node_name = 'dl';
 ...
 * \see http://www.w3.org/TR/html4/struct/lists.html#h-10.3
 */
final class AnewtXHTMLDefinitionTerm extends AnewtXHTMLElement
{
	public $node_name = 'dt';
}
 ...
 * \see http://www.w3.org/TR/html4/struct/lists.html#h-10.3
 */
final class AnewtXHTMLDefinitionDescription extends AnewtXHTMLElement
{
	public $node_name = 'dd';
}
