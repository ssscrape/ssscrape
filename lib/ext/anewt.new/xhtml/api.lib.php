...
/**
 * Create an AnewtXHTMLAnchor element with a \c href attribute.
 * \param $content The content for this element
 * \param $href The link target used for the \c href attribute
 * \param $attributes Additional element attributes (optional)
 */
...
/**
 * Create an AnewtXHTMLAnchor element with \c href and \c rel attributes.
 * \param $content The content for this element
 * \param $href The link target used for the \c href attribute
 * \param $rel The value for the \c rel attribute
 * \param $attributes Additional element attributes (optional)
 */
...
/**
 * Create an AnewtXHTMLAnchor element with \c href and \c title attributes.
 * \param $content The content for this element
 * \param $href The link target used for the \c href attribute
 * \param $title The value for the \c title attribute
 * \param $attributes Additional element attributes (optional)
 */
...
/**
 * Create an image element with an \c alt attribute.
 * \param $src Source for the image
...
/**
 * Create an image element with \c alt and \c title attributes.
 * \param $src Source for the image
 * \param $alt The alternative text for the image
...
/**
 * Create an AnewtXHTMLStyle element with an \c href attribute.
 * \param $href The link target used for the \c href attribute
 * \param $attributes Additional element attributes (optional)
 */
...
/**
 * Create an AnewtXHTMLStyle element with \c href and \c media attributes.
 * \param $href The link target used for the \c href attribute
 * \param $media The value for the \c media attribute
 * \param $attributes Additional element attributes (optional)
 */
...
/**
 * Create an AnewtXHTMLScript element for JavaScript with a \c src attribute.
...
/**
 * Create an AnewtXHTMLMeta element with \c name and \c content attributes.
 * \param $name The value for the \c name attribute
 * \param $content The value for the \c content attribute
 * \param $attributes Additional element attributes (optional)
 */
